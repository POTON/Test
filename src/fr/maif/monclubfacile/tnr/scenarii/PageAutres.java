...
public class PageAutres {  
	...
	private void LaunchTest() throws Exception {
		...
		clickAutres.ClickAutres(driver, logger);
		Thread.sleep(2000);
		clickAutres.ClickTarif(driver, logger);
		Thread.sleep(3000);
		clickAutres.ClickComment(driver, logger);
		Thread.sleep(3000);
		clickAutres.ClickSecu(driver, logger);
		Thread.sleep(3000);
		clickAutres.ClickMentionsLega(driver, logger);
		Thread.sleep(3000);
		clickAutres.ClickConditGen(driver, logger);
		Thread.sleep(3000);
		clickAutres.ClickMaquet(driver, logger);
		Thread.sleep(3000);
		clickAutres.ClickDocum(driver, logger); 
		Thread.sleep(3000);
		clickAutres.Deconnexion(driver, logger);  
	} 
