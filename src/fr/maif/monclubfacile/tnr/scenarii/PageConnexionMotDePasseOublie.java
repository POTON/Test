...
import fr.maif.monclubfacile.tnr.modules.ConnexionMotDePasseOublie;
import fr.maif.monclubfacile.tnr.modules.Login;
import fr.maif.monclubfacile.tnr.modules.Verif;

@SuppressWarnings("unused")
public class PageConnexionMotDePasseOublie { 
	...
	private ConnexionMotDePasseOublie connex = new ConnexionMotDePasseOublie(); 
	...
	private void LaunchTest() throws Exception {
		...
		connex.MotDepasseOublie(driver, logger);    
	}
